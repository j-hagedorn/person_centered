...
The table below suggests how existing paradigms can be used to augment these policy requirements and be incorporated into our framework: 
...
## Vision for a Better Life (QoL)


## Turning Vision into Plan (COM-B)
...
<!-- Add refs to Arduin, MBC, etc. related to PDCA -->
...
<!-- How does COM-B fit in here?  Use specific examples. -->
