...
This document is intended to serve as a scaffolding: a working document feeding multiple system redesign efforts which MDHHS-BHDDA is undertaking.  While it is technical in some parts, this format is intended to assure that no part of the broad scope of PCP is neglected in long-term system design.
